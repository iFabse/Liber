...
<head>
    ...
    <link rel="icon" href="../../../doc/pommes.png">
</head>
<body>
<div class="container">
<div class="main">
    ...
    <br>
    <br>
    <img class="bild" src="../../../doc/pommes.png" width="200" height="120"><br><br><br>
    <form action="datenbank.php" method="POST">
        <div class="bezeichnung">
            <details>
                ...
                <div class="infos">
                <br>
                Pommes aus der Friteuse. Bitte bei Extras angeben, ob mit Mayo, Ketchup oder nicht
                </div>
                <br>
            </details>
            <br>
