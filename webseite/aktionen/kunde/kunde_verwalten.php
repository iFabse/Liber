...
if (!isset($_SESSION['login_user'])) {
    $wert = "webseite/aktionen/kunde/kunde_verwalten.php";
...
<body>
    <div class="container">
        <div class="main">
            ...
            <div class="container my-5">
                <table class="table">
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT * FROM kunden"; // Alles von Kunden anzeigen
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            <tr>
                                ...
                                <td>$row[rfid]</td>
                                <td>
                                    <a class='btn btn-danger btn-sm' href='delete.php?namen=$row[namen]'>Löschen</a>
                                </td>
                            </tr>
                            ";
            ...
            <form action='erstelle_kunde.php'>
                <button class="katHinzufügen" type='submit' name='delete-button'>
                    Kunde <img class='logoutBild' src='../../doc/plus.png' alt='Abmelden'> Hinzufügen
                </button>
            </form>
        </div>
    </div>
